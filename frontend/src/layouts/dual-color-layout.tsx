...
export default function DualColorLayout({
                                            left,
                                            right,
                                            steps,
                                            currentStep,
...
function DualSplitContent({
    ...
    return (
        <main className="relative flex-1 w-full overflow-visible px-0 pb-0 pt-0">
            ...
            <div className="grid min-h-[calc(100vh-var(--header-height))] w-full grid-cols-1 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,0.3fr)]">
