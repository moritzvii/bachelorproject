...
type DualColorLayoutEightyTwentyProps = {
    left?: ReactNode;
    right?: ReactNode;
...
export default function DualColorLayoutEightyTwenty({
                                                        left,
                                                        right,
                                                        steps,
                                                        currentStep,
                                                        ...
                                                        leftClassName,
                                                        rightClassName,
                                                    }: DualColorLayoutEightyTwentyProps) {
    return (
...
function DualSplitContent({
    ...
    return (
        <main className="relative flex-1 w-full overflow-visible px-0 pb-0 pt-0">
            ...
            <div className="grid min-h-[calc(100vh-var(--header-height))] w-full grid-cols-1 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,0.2fr)]">
                <section className="relative flex h-full min-h-[320px] items-start justify-center overflow-y-auto">
                    <div
                        className={cn(
                            "relative z-10 flex w-full max-w-5xl items-start justify-start bg-transparent p-8 text-slate-900",
                            leftClassName,
                        )}
                    >
                        {left ?? null}
